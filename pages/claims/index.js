              ...
              {(!currentUseState.isConnected) ?
                <Col lg="6" md="6" className="align-self-center">
                  ...
                  <Link href={process.env.mainWWW}>
                    <a className="btn btn-md m-t-30  btn-outline-light " style={{ backgroundColor: "#044022" }}>
                      Back Home
                    </a>
                  </Link>
                </Col> :
                  ...
                  {(currentUseState.isPrivateMintIsOpen) ?
                    <>
                      ...
                      {(process.env.enforceWhitelist == false || currentUseState.xmPower.isWhiteListed == true) ?
                        <>
                          {(currentUseState.isWaiting == false) ?
                            <>
                              <label className="connected">Number of Claimable Demon Squad NFT's (1-{currentUseState.whiteListPass.q}):</label>
                              <div className="">
                      ...
                      <a
                        ...
                        className="btn btn-md m-t-30 btn-outline-light " style={{ backgroundColor: "#044022" }}
